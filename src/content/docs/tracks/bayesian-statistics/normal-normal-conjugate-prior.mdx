...
If you measure five men in a city and their average height is 175 cm, is the true average height of the city exactly 175 cm? What if you already knew the national average was 178 cm?

Following the same principles as the [Beta-Bernoulli Conjugate Prior](/tracks/bayesian-statistics/beta-bernoulli-conjugate-prior/), we can apply Bayesian updating to continuous data.
